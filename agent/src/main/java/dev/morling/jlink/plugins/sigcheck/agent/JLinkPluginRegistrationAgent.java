 ...
 */
package dev.morling.jlink.plugins.sigcheck.agent;
...
public class JLinkPluginRegistrationAgent {
    ...
    public static void premain(String agentArgs, Instrumentation inst) throws Exception {
        ...
        Module addIndexModule = ModuleLayer.boot().findModule( "dev.morling.jlink.plugins.sigcheck" ).get();
        ...
        Class<?> addIndexPluginClass = addIndexModule.getClassLoader().loadClass( "dev.morling.jlink.plugins.sigcheck.SignatureCheckPlugin" );
